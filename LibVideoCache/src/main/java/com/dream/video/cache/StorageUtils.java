...
final class StorageUtils {
    ...
    private static File getCacheDirectory(Context context, boolean preferExternal) {
        ...
        if (appCacheDir == null) {
            ...
            LogUtils.wTag(StorageUtils.class.getName(),"Can't define system cache directory! %s will be used.",cacheDirPath);
    ...
    private static File getExternalCacheDir(Context context) {
        ...
        if (!appCacheDir.exists()) {
            if (!appCacheDir.mkdirs()) {
                LogUtils.wTag(StorageUtils.class.getName(),"Unable to create external cache directory");
                return null;
            }
        }
        return appCacheDir;
